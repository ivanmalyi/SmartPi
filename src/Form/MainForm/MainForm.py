...
class Ui_Form_Main(object):
    def setupUi(self, Form_Main):
        ...
        self.pushButton_salonLight = QtWidgets.QPushButton(Form_Main)
        self.pushButton_salonLight.setGeometry(QtCore.QRect(160, 230, 191, 81))
        font = QtGui.QFont()
        font.setPointSize(16)
        self.pushButton_salonLight.setFont(font)
        self.pushButton_salonLight.setObjectName("pushButton_salonLight")
    ...
    def retranslateUi(self, Form_Main):
        ...
        self.pushButton_salonLight.setText(_translate("Form_Main", "свет в салоне"))
